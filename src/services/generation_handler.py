...
class GenerationHandler:
    ...
    async def handle_generation(
        ...
        if self.proxy_manager:
            await self.proxy_manager.bind_request_proxy()
        ...
        try:
            ...
            if self.proxy_manager:
                if self.proxy_manager.get_bound_proxy_url() is not None:
                    await self.proxy_manager.record_request_result(request_succeeded)
