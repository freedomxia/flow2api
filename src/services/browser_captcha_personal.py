...
if IS_DOCKER and not HAS_DISPLAY:
    debug_logger.log_warning("[BrowserCaptcha] 检测到 Docker 环境但未配置 DISPLAY，内置浏览器打码不可用")
    print("[BrowserCaptcha] ⚠️ 检测到 Docker 环境但未配置 DISPLAY，内置浏览器打码不可用")
